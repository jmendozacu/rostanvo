...
if(PostAffTracker==undefined){var PostAffTracker=new function(){var integrationElementId='pap_x2s6df8d';var flashUrl,requestUrl;this._cmanager=new PostAffCookieManager();var affInfo=new PostAffInfo(this._cmanager);var separator;var actionObjects=new Array();var accountId;var executeOnResponce=new Array();var executeAfterSetAffResponse=new Array();var skipIframeCheck=false;this.afterSetAffResponseCounter=0;function computeUrl(){var url=new String(document.getElementById(integrationElementId).src);flashUrl=requestUrl=url.substr(0,url.lastIndexOf('/')+1);}
