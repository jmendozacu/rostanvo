...
class Pap3Compatibility_Migration_TaskSalesCommissions extends Pap3Compatibility_Migration_LongTask {
	...
	public function getSelect() {
        ...
        $selectBuilder->where->add('t.transtype', 'in', array(Pap3Compatibility_Migration_Pap3Constants::TRANSTYPE_SALE, Pap3Compatibility_Migration_Pap3Constants::TRANSTYPE_LEAD));
