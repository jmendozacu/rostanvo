 ...
 * @package GwtPhpFramework
 */
class Gpf_Db_Table_UserBroadcasts extends Gpf_DbEngine_Table {
    const CREATED = 'created';
    
    private static $instance;
        
    /**
     * @return Gpf_Db_Table_UserBroadcasts
     */
    ...
    protected function initName() {
        $this->setName('nl_user_broadcasts');
    }
    ...
    protected function initColumns() {
        $this->createPrimaryColumn(Gpf_Db_Table_Broadcasts::ID, 'char', 8, true);
