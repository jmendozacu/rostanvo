...
*/
  ...
  */
  ...
  class Gpf_BarCode_Type_I25 extends Gpf_BarCode_Type_BarCode {
   var $mCharSet;
   function Gpf_BarCode_Type_I25($Width, $Height, $Style, $Value)
   {
   ...
   function GetSize($xres)
   {
	 ...
	 if (($len%2) != 0) {
	    $this->mError = "The length of barcode value must be even";
   	    throw new Gpf_BarCode_Exception("GetSize: failed I25 requiremente");
		return false;
		}		 
