 ...
 * @package PostAffiliatePro
 */
class Pap_Mail_Reports_DailyReport extends Pap_Mail_Reports_Report {

	public function __construct(Pap_Stats_Params $statsParams = null) {
		parent::__construct($statsParams);
		$this->subject = Gpf_Lang::_runtime('Daily report');
	}

	protected function initTemplate() {
		$this->mailTemplateFile = 'daily_report.stpl';
		$this->templateName = Gpf_Lang::_runtime('Merchant - Daily report');
	}

	protected function initDate(Pap_Stats_Params $statsParams, $timeOffset) {
		$filter = new Gpf_SqlBuilder_Filter(array("month", "DP", "Y"));
