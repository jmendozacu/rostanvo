 ...
 * @package PostAffiliatePro
 */
class Pap_Mail_Reports_AffWeeklyReport extends Pap_Mail_Reports_WeeklyReport {

	protected function initTemplate() {
		$this->mailTemplateFile = 'aff_weekly_report.stpl';
		$this->templateName = Gpf_Lang::_runtime('Affiliate - Weekly report');
	}
