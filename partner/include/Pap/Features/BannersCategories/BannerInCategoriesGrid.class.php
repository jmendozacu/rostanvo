 ...
 * @package PostAffiliatePro
 */
class Pap_Features_BannersCategories_BannerInCategoriesGrid extends Gpf_View_GridService {
    ...
    protected function initDataColumns() {
        ...
        $this->addDataColumn('selected', "IF (c.".Pap_Db_Table_BannersInCategory::BANNERID." is null, 'N', 'Y')");
    }
    ...
    protected function buildWhere() {
        ...
        if (count($bannerFilter) > 0) {
            $this->_selectBuilder->where->add('c.'.Pap_Db_Table_BannersInCategory::BANNERID,'=',$bannerFilter[0]->getValue());
        }
        parent::buildWhere();
    }
