...
class Magestore_Customerreward_Model_Mysql4_Rule_Collection extends Mage_Core_Model_Mysql4_Collection_Abstract
{
    ...
    public function getAvailableRule($customer,$order){
