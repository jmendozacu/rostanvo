...
class Magestore_Customerreward_Block_Adminhtml_Offer_Edit_Tab_Category extends Mage_Adminhtml_Block_Catalog_Category_Tree
{
    ...
    {
    	return $this->getProgram()->getCategories();
    }
