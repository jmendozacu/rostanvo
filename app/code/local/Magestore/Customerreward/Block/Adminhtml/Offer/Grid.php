...
class Magestore_Customerreward_Block_Adminhtml_Offer_Grid extends Mage_Adminhtml_Block_Widget_Grid
{
  ...
  {
      $collection = Mage::getModel('customerreward/offer')->getCollection();
